...
import slientclient.discord.ClientDC;
import slientclient.main.GuiInGameHook;
...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle(slient.clientName + " " + slient.clientVersion);
    ...
    private void runTickKeyboard() throws IOException
    {
        while (Keyboard.next())
        {
            ...
            if (flag)
            {
                ...
                if (this.currentScreen == null)
                {	
                	Slient.onKeyPressed(i);
                	
                	Slient.tabManager.keyPressed(i);
    ...
    public void launchIntegratedServer(String folderName, String worldName, @Nullable WorldSettings worldSettingsIn)
    {
        ...
        ClientDC.getInstance().getDiscord().update("Tek oyunculu ", "oynuyor.");
    }
	...
	public void dispatchPacket(Packet packet, Object object) {
