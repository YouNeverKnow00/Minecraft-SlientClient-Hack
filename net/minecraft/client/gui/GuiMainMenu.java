...
public class GuiMainMenu extends GuiScreen
{
    ...
    private static final ResourceLocation field_194400_H = new ResourceLocation("slientclientwallpaper/lol.jpg");

    /** An array of all the paths to the panorama pictures. */
    private static final ResourceLocation[] TITLE_PANORAMA_PATHS = new ResourceLocation[] {new ResourceLocation("slientclientwallpaper/lol.jpg"), new ResourceLocation("slientclientwallpaper/lol.jpg"), new ResourceLocation("slientclientwallpaper/lol.jpg"), new ResourceLocation("slientclientwallpaper/lol.jpg"), new ResourceLocation("slientclientwallpaper/lol.jpg"), new ResourceLocation("slientclientwallpaper/lol.jpg")};
    ...
    public void initGui()
    {
    	ClientDC.getInstance().getDiscord().update("Bosta", "Ana Menude.");
        this.viewportTexture = new DynamicTexture(256, 256);
        this.backgroundTexture = this.mc.getTextureManager().getDynamicTextureLocation("slientclientwallpaper/lol.jpg", this.viewportTexture);
        this.field_193978_M = this.fontRendererObj.getStringWidth("§bSlientClient Beta");
        ...
        {
            this.splashText = "SlientClient b0.1!";
        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.mc.getTextureManager().bindTexture(new ResourceLocation("slientclientwallpaper/lol.jpg"));
        ...
        String s = Slient.clientnamecolor + Slient.clientversioncolor ;
        ...
        this.drawString(this.fontRendererObj, Slient.clientdes, this.field_193979_N, this.height - 10, -1);
		...
		final int[] countert = {1};
        int x = scaledRes.getScaledWidth() / 2;
        GL11.glScalef(5.0F, 5.0F, 0.0F);
        drawCenteredString(this.fontRendererObj, Slient.clientnamecolorainbow1 + Slient.clientnamecolorainbow2 , x / 5, height / 40, rainbow (countert[0] * 5));
        GL11.glPopMatrix();
		countert[0]++;
