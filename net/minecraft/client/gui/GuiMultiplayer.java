...
public class GuiMultiplayer extends GuiScreen
{
    ...
    public void initGui()
    {
    	ClientDC.getInstance().getDiscord().update("Bosta", "Cok Oyunculu Menude.");
    ...
    public void createButtons()
    {
        ...
        this.buttonList.add(new GuiButton(3, this.width / 2 + 4 + 50, this.height - 52, 75, 20, I18n.format("selectServer.add")));
        this.buttonList.add(new GuiButton(8, this.width / 2 + 4, this.height - 28, 70, 20, I18n.format("selectServer.refresh")));
        this.buttonList.add(new GuiButton(0, this.width / 2 + 4 + 76, this.height - 28, 86, 20, I18n.format("gui.cancel")));
        this.buttonList.add(new GuiButton(666, this.width / 2 + 4 + 50 + 80, this.height - 52, 32, 20, "§aTools"));
