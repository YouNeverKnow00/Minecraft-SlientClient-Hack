...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public boolean addToSendQueue(Packet p_147297_1_)
    {
    	for (Module m : Slient.getModules()){
    		if (m.isToggled()) {
    			m.onPacketSend(p_147297_1_);
    			if (m.isOutboundPacketCancelled() && !Values.getValues().convertpacket) {
    ...
    public void handleChat(SPacketChat packetIn){
    	...
    	if(Slient.onRecieveChatMessage(packetIn)){
            PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
